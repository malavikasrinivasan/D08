...
def main():
    ...
    participant_index = getRandomParticipantIndex(bootcampParticipants)
    name = getPerson(participant_index, bootcampParticipants)

    # print person's name who has excuse today.
    print("{} has an excuse today.".format(name))
    #
    # print person's name who has excuse today.
